# OpenWhisper Community Skills Pilot Launch Kit
...
content. The OpenWhisper product owner must approve the study owner, recruitment
...
enter the Pilot CSV files or OpenWhisper diagnostics.

### Recruitment copy — English

> We are running a four-week private study of OpenWhisper Community Skills on
> macOS. The study observes whether task-specific Skills make voice input easier
> to review and apply. Participation is voluntary. OpenWhisper does not upload
...
> 我们正在进行一项为期四周的 OpenWhisper Community Skills macOS 私有研究，
> 目的是了解面向具体任务的 Skill 是否能让语音输入更容易审阅和使用。参与完全自愿。
> OpenWhisper 不会自动上传研究数据；研究员只记录分桶后的结果，以及你明确选择分享的
