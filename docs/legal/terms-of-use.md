...
You must not use VibeCompose to:

- violate law or another person's rights;
- capture audio without required notice or consent;
- access or transmit data you are not authorized to process;
- attack, overload, bypass, or interfere with VibeCompose or a connected service;
- distribute credentials, malicious payloads, or deceptive builds under the VibeCompose name.
...
VibeCompose's package checks limit executable behavior but do not verify that a
...
The VibeCompose name, logo, and release signing identity are separate project assets and are not licensed merely because source code is MIT-licensed.
...
To the maximum extent permitted by law, VibeCompose is provided "as is" and "as available," without warranties of uninterrupted operation, transcription accuracy, fitness for a particular purpose, non-infringement, or compatibility with every app or third-party service.

## 8. Limitation of Liability

To the maximum extent permitted by law, the VibeCompose project and its contributors will not be liable for indirect, incidental, special, consequential, exemplary, or punitive damages, or for lost data, lost profits, account restrictions, failed transcription, or incorrect insertion. Rights that cannot legally be excluded remain unaffected.
