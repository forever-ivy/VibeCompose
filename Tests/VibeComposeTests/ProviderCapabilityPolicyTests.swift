    ...
    try ProviderCapabilityPolicyConfiguration(
        infoDictionary: [
            "OWCapabilityPolicyURL":
                "https://updates.vibecompose.example/provider-capabilities.json",
...
private func capabilityTestDirectory() throws -> URL {
    let url = FileManager.default.temporaryDirectory
        .appendingPathComponent(
            "VibeComposeCapabilityPolicyTests-\(UUID().uuidString)",
            isDirectory: true
        )
...
func capabilityPolicyConfigurationRequiresPairedHTTPSURLAndEd25519Key() throws {
    ...
    #expect(
        ...
        _ = try ProviderCapabilityPolicyConfiguration(
            infoDictionary: [
                "OWCapabilityPolicyURL":
                    "https://updates.vibecompose.example/policy.json?token=secret",
                "OWCapabilityPublicEDKey":
    ...
    #expect(
        ...
        _ = try ProviderCapabilityPolicyConfiguration(
            infoDictionary: [
                "OWCapabilityPolicyURL":
                    "https://updates.vibecompose.example/policy.json",
                "OWCapabilityPublicEDKey":
