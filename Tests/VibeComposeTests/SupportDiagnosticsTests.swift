...
func supportDiagnosticsExportIsRedactedBoundedAndChecksummed() throws {
    ...
    let root = fileManager.temporaryDirectory
        .appendingPathComponent(
            "VibeComposeSupportDiagnosticsTests-\(UUID().uuidString)",
            isDirectory: true
        )
    let applicationSupportURL = root
        .appendingPathComponent("Application Support/VibeCompose", isDirectory: true)
    ...
    let crashHeader: [String: Any] = [
        "app_name": "VibeCompose",
        "app_version": "0.1.0",
        "build_version": "1",
        "bundleID": "app.vibecompose.mac",
        "bug_type": "309",
        "os_version": [
            "build": "25F90",
    ...
    try crashData.write(
        to: diagnosticReportsURL
            .appendingPathComponent("VibeCompose-2026-07-13.ips")
    )
    ...
    try fileManager.createSymbolicLink(
        at: diagnosticReportsURL
            .appendingPathComponent("VibeCompose-symlink.ips"),
    ...
    let exporter = SupportDiagnosticsExporter(
        ...
        environment: SupportDiagnosticsEnvironment(
            ...
            productBuild: "1",
            bundleIdentifier: "app.vibecompose.mac",
...
private func extractZip(_ archiveURL: URL, to destinationURL: URL) throws {
    ...
    if process.terminationStatus != 0 {
        ...
        throw NSError(
            domain: "VibeCompose.SupportDiagnosticsTests",
