...
func snapshotPrivacyModeRecognizesEveryProductSurfaceCapture() {
    let cases: [([String: String], [String])] = [
        (["VIBECOMPOSE_SETTINGS_SNAPSHOT_OUTPUT": "/tmp/settings.png"], []),
        (["VIBECOMPOSE_ONBOARDING_SNAPSHOT_OUTPUT": "/tmp/onboarding.png"], []),
        (["VIBECOMPOSE_HISTORY_SNAPSHOT_OUTPUT": "/tmp/history.png"], []),
        (["VIBECOMPOSE_TERMINOLOGY_SNAPSHOT_OUTPUT": "/tmp/terminology.png"], []),
        (["VIBECOMPOSE_QUICK_ADD_SNAPSHOT_OUTPUT": "/tmp/quick-add.png"], []),
        (["VIBECOMPOSE_ACCESSIBILITY_AUDIT_OUTPUT": "/tmp/audit.json"], []),
        (["VIBECOMPOSE_INTERACTION_ACCEPTANCE": "true"], []),
        (["VIBECOMPOSE_VISUAL_ACCEPTANCE_OUTPUT": "/tmp/hud.png"], []),
        (
            ["VIBECOMPOSE_VISUAL_ACCEPTANCE_FOLLOWUP_OUTPUT": "/tmp/hud-2.png"],
            []
        ),
