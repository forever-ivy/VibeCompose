...
@Test
func visualAcceptanceScriptRunsInstalledVibeComposeOverlayDemo() throws {
    ...
    #expect(!script.contains("dist/VibeCompose.app/Contents/MacOS/VibeCompose"))
}
...
func bilingualSettingsAcceptanceUsesInstalledMinimumSizeSnapshots() throws {
    ...
    #expect(script.contains("/usr/bin/open \"$APP_DIR\""))
    #expect(!script.contains("dist/VibeCompose.app/Contents/MacOS"))
}
