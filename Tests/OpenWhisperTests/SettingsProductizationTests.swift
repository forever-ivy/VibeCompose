...
func settingsSourceKeepsTheNativeAutosavingContract() throws {
    ...
    #expect(source.contains("AppModeRule.validated"))
    #expect(source.contains("config.transcription.voiceModes.upsert"))
    #expect(source.contains("voiceModes.requiresTextPolish"))
    ...
    #expect(source.contains("Voice Modes require OpenWhisper Pro"))
