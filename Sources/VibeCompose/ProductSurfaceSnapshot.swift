...
enum ProductSurfaceSnapshotError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .missingContentView:
            return "The VibeCompose product window has no content view to capture."
        case .bitmapUnavailable:
            return "The VibeCompose product window could not create a bitmap snapshot."
        case .visuallyEmptyWindowCapture:
            return "The VibeCompose window capture was visually empty."
        case .pngEncodingFailed:
            return "The VibeCompose product window could not encode its snapshot as PNG."
        }
    }
}
