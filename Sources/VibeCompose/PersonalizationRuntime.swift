...
enum StyleCapsuleRegistry {
    ...
    static let academicWritingID =
        "builtin.academic-writing"
    static let executiveSummaryID =
        "builtin.executive-summary"
    static let codeDocumentationID =
        "builtin.code-documentation"
    ...
    Equatable
{
    ...
    var errorDescription: String? {
        ...
        case .symbolicLink:
            return L10n.text(
                "VibeCompose blocked a symbolic link in Writing Style storage."
            )
        case .oversized:
            return L10n.text(
...
enum TerminologyPackRegistry {
    static let backendID =
        "app.vibecompose.terms.backend"
    static let medicalID =
        "app.vibecompose.terms.medical"
    static let kubernetesID =
        "app.vibecompose.terms.kubernetes"
    static let frontendEngineeringID =
        "app.vibecompose.terms.frontend"
    static let devopsID =
        "app.vibecompose.terms.devops"
    static let dataScienceID =
        "app.vibecompose.terms.data-science"
    static let productManagementID =
        "app.vibecompose.terms.product-management"
