...
enum ThirdPartyLicenseCatalogError: Error, Equatable, LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .missingResourceRoot:
            return L10n.text(
                "VibeCompose could not find its bundled third-party license resources."
            )
        case .invalidManifest:
            return L10n.text(
                "VibeCompose could not read its third-party license manifest."
            )
        case .unsupportedSchema(let version):
            return L10n.format(
                "VibeCompose cannot read third-party license manifest schema %ld.",
                version
            )
