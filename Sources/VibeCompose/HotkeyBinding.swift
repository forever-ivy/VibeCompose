...
extension HotkeyBindingValidationError: LocalizedError {
    var errorDescription: String? {
        ...
        case .quickAddConflict:
            return L10n.text(
                "This shortcut is already used by VibeCompose Quick Add."
            )
        }
    }
}
...
enum VibeComposeShortcutConflictError:
    Error,
    Equatable,
    Sendable,
    LocalizedError
...
enum VibeComposeShortcutSetValidator {
    static func validate(
        ...
        if let skillSwitcher {
            ...
            guard skillSwitcher != dictation else {
                throw VibeComposeShortcutConflictError
