...
enum AppInstallLocation {
    ...
    static func launchBlocker(bundleURL: URL = Bundle.main.bundleURL) -> LaunchBlocker? {
        ...
        return LaunchBlocker(
            message: L10n.format(
                "VibeCompose must be installed to /Applications/VibeCompose.app before it runs. This copy is at %@. Rebuild, install the packaged app to /Applications, then launch that installed copy.",
