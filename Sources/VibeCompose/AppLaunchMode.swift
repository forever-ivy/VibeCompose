...
enum AppLaunchMode: Equatable {
    ...
    static func resolve(
        ...
        let benchmarkValue = environment["VIBECOMPOSE_BENCHMARK"]?
        ...
        if arguments.contains("--overlay-demo") || arguments.contains("--vibecompose-overlay-demo") {
            return .overlayDemo
        }
        ...
        let rawValue = environment["VIBECOMPOSE_OVERLAY_DEMO"]?
            .trimmingCharacters(in: .whitespacesAndNewlines)
            .lowercased()
    ...
    static func visualAcceptanceOutputURL(
        ...
        if let value = environment["VIBECOMPOSE_VISUAL_ACCEPTANCE_OUTPUT"]?
            .trimmingCharacters(in: .whitespacesAndNewlines),
            !value.isEmpty
        {
    ...
    static func visualAcceptanceFollowupOutputURL(
        ...
        productSurfaceSnapshotOutputURL(
            environment: environment,
            arguments: arguments,
            environmentKey: "VIBECOMPOSE_VISUAL_ACCEPTANCE_FOLLOWUP_OUTPUT",
    ...
    static func feedbackSurfaceDebugOutputURL(
        ...
        productSurfaceSnapshotOutputURL(
            ...
            arguments: arguments,
            environmentKey:
                "VIBECOMPOSE_FEEDBACK_SURFACE_DEBUG_OUTPUT",
            argumentName:
    ...
    static func visualAcceptanceDisplayOptionsOverride(
        ...
        AccessibilityDisplayOptionsOverride(
            reduceMotion: optionalBooleanLaunchValue(
                environment: environment,
                arguments: arguments,
                environmentKey: "VIBECOMPOSE_VISUAL_ACCEPTANCE_REDUCE_MOTION",
                argumentName: "--visual-acceptance-reduce-motion"
            ),
            increaseContrast: optionalBooleanLaunchValue(
                environment: environment,
                arguments: arguments,
                environmentKey: "VIBECOMPOSE_VISUAL_ACCEPTANCE_INCREASE_CONTRAST",
    ...
    static func pasteAcceptanceOutputURL(
        ...
        if let value = environment["VIBECOMPOSE_PASTE_ACCEPTANCE_OUTPUT"]?
            .trimmingCharacters(in: .whitespacesAndNewlines),
            !value.isEmpty
        {
            return URL(fileURLWithPath: value)
    ...
    static func pasteAcceptanceTarget(
        ...
        if let value = environment[
            "VIBECOMPOSE_PASTE_ACCEPTANCE_TARGET"
        ]?
        .trimmingCharacters(in: .whitespacesAndNewlines)
        .lowercased(),
            !value.isEmpty
    ...
    static func accessibilityAuditOutputURL(
        ...
        productSurfaceSnapshotOutputURL(
            environment: environment,
            arguments: arguments,
            environmentKey: "VIBECOMPOSE_ACCESSIBILITY_AUDIT_OUTPUT",
    ...
    static func interactionAcceptanceRequested(
        ...
        let environmentValue = environment[
            "VIBECOMPOSE_INTERACTION_ACCEPTANCE"
        ]?
        .trimmingCharacters(in: .whitespacesAndNewlines)
        .lowercased()
    ...
    static func settingsSnapshotOutputURL(
        ...
        if let value = environment["VIBECOMPOSE_SETTINGS_SNAPSHOT_OUTPUT"]?
            .trimmingCharacters(in: .whitespacesAndNewlines),
            !value.isEmpty
        {
            return URL(fileURLWithPath: value)
    ...
    static func onboardingSnapshotOutputURL(
        ...
        if let value = environment["VIBECOMPOSE_ONBOARDING_SNAPSHOT_OUTPUT"]?
            .trimmingCharacters(in: .whitespacesAndNewlines),
            !value.isEmpty
        {
            return URL(fileURLWithPath: value)
    ...
    static func historySnapshotOutputURL(
        ...
        productSurfaceSnapshotOutputURL(
            environment: environment,
            arguments: arguments,
            environmentKey: "VIBECOMPOSE_HISTORY_SNAPSHOT_OUTPUT",
    ...
    static func terminologySnapshotOutputURL(
        ...
        productSurfaceSnapshotOutputURL(
            environment: environment,
            arguments: arguments,
            environmentKey: "VIBECOMPOSE_TERMINOLOGY_SNAPSHOT_OUTPUT",
    ...
    static func quickAddSnapshotOutputURL(
        ...
        productSurfaceSnapshotOutputURL(
            environment: environment,
            arguments: arguments,
            environmentKey: "VIBECOMPOSE_QUICK_ADD_SNAPSHOT_OUTPUT",
    ...
    static func skillLibrarySnapshotOutputURL(
        ...
        productSurfaceSnapshotOutputURL(
            environment: environment,
            arguments: arguments,
            environmentKey: "VIBECOMPOSE_SKILL_LIBRARY_SNAPSHOT_OUTPUT",
    ...
    static func skillSwitcherSnapshotOutputURL(
        ...
        productSurfaceSnapshotOutputURL(
            environment: environment,
            arguments: arguments,
            environmentKey: "VIBECOMPOSE_SKILL_SWITCHER_SNAPSHOT_OUTPUT",
    ...
    static func previewSnapshotOutputURL(
        ...
        productSurfaceSnapshotOutputURL(
            ...
            arguments: arguments,
            environmentKey:
                "VIBECOMPOSE_PREVIEW_SNAPSHOT_OUTPUT",
            argumentName:
    ...
    static func settingsSnapshotSize(
        ...
        if let value = environment["VIBECOMPOSE_SETTINGS_SNAPSHOT_SIZE"],
    ...
    private static func overlayDemoState(
        ...
        if let rawState = environment["VIBECOMPOSE_OVERLAY_DEMO_STATE"],
